...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _strings = {
    'en': {
      ...
      // Slip scanner
      'scanBankSlip': 'Scan Bank Slip',
      'scanningSlip': 'Scanning slip...',
      'autoFillFromSlip': 'Auto-fill amount, date and note from slip',
      'takePhoto': 'Take photo',
      'useCameraForSlip': 'Use camera to capture slip',
      'chooseFromGallery': 'Choose from gallery',
      'pickExistingSlip': 'Pick an existing slip photo',
      'slipScanned': 'Slip scanned!',
      'couldNotReadSlip': 'Could not read slip data. Please fill in manually.',
    ...
    'lo': {
      ...
      // Slip scanner
      'scanBankSlip': 'ສະແກນໃບໂອນ',
      'scanningSlip': 'ກຳລັງສະແກນ...',
      'autoFillFromSlip': 'ຕື່ມຈຳນວນ, ວັນທີ ແລະ ໝາຍເຫດ ອັດຕະໂນມັດ',
      'takePhoto': 'ຖ່າຍຮູບ',
      'useCameraForSlip': 'ໃຊ້ກ້ອງຖ່າຍໃບໂອນ',
      'chooseFromGallery': 'ເລືອກຈາກຄັງຮູບ',
      'pickExistingSlip': 'ເລືອກຮູບໃບໂອນທີ່ມີຢູ່',
      'slipScanned': 'ສະແກນສຳເລັດ!',
      'couldNotReadSlip': 'ບໍ່ສາມາດອ່ານຂໍ້ມູນໃບໂອນ. ກະລຸນາຕື່ມຂໍ້ມູນດ້ວຍຕົນເອງ.',
      'scanFailed': 'ການສະແກນລົ້ມເຫຼວ. ກະລຸນາຕື່ມຂໍ້ມູນດ້ວຍຕົນເອງ.',
      'today': 'ມື້ນີ້',
      'lastDay': 'ມື້ວານນີ້',
      'thisMonth': 'ເດືອນນີ້',
      'lastMonth': 'ເດືອນກ່ອນ',
